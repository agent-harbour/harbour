...
func printUsage() {
	...
	fmt.Println("Homebrew installs Colima automatically for the formula.")
	fmt.Println("If you are not using Homebrew, install Colima before running harbour provision: brew install colima")
	fmt.Println()
